...
import com.bailout.stick.databinding.FragmentChargingTheProsthesisBinding
...
class ChargingTheProsthesesFragment: Fragment() {
    private var mContext: Context? = null
    private var main: MainActivity? = null

    private lateinit var binding: FragmentChargingTheProsthesisBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentChargingTheProsthesisBinding.inflate(layoutInflater)
