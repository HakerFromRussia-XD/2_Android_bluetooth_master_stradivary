...
public class GripperTestSettingsWithEncodersRenderer implements GLSurfaceView.Renderer{
	...
	private final me.start.motorica.new_electronic_by_Rodeon.ui.activities.gripper.test_encoders.ErrorHandler errorHandler;
			...
			try {
				...
				for (i = 0; i<MAX_NUMBER_DETAILS; i++){
					...
					if (vbo[0] > 0 && ibo[0] > 0) {
						...
						errorHandler.handleError(me.start.motorica.new_electronic_by_Rodeon.ui.activities.gripper.test_encoders.ErrorHandler.ErrorType.BUFFER_CREATION_ERROR, "glGenBuffers");
					}
				}
			} catch (Throwable t) {
				Timber.tag(TAG).w(t);
				errorHandler.handleError(me.start.motorica.new_electronic_by_Rodeon.ui.activities.gripper.test_encoders.ErrorHandler.ErrorType.BUFFER_CREATION_ERROR, t.getLocalizedMessage());
			}
		}
