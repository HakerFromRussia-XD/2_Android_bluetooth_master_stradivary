...
import com.bailout.stick.databinding.FragmentCareOfProstheticHandBinding
...
class ProsthesesCareFragment: Fragment() {
    private var mContext: Context? = null
    private var main: MainActivity? = null

    private lateinit var binding: FragmentCareOfProstheticHandBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentCareOfProstheticHandBinding.inflate(layoutInflater)
