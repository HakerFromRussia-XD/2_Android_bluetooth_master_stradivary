...
//    характеристики переработанного стека для Новой Ваниной и Мишиной версии
    ...
    public static String ROTATION_GESTURE_NEW_VM = "43680400-4d74-1001-726b-526f64696f6e";// 4 байта, превый 0/1 - вкл/выкл; второй - тип 0 - Одиночное сжетие обеих мышц, 1 - дабл тап, 2 - нажатие в упоре; третий - продожительность пика, четвёртый - продолжительность паузы (единица 1/20 секунды (такт датчика))
