...
final class GestureWidgetsListViewController: UIViewController, StoryboardInstantiable, Alertable {
...
//    private let defaultDisplay: Int32 = 1
    ...
    // MARK: - Lifecycle
    static func create(with viewModel: WidgetsListViewModel) -> GestureWidgetsListViewController {
        let view = GestureWidgetsListViewController.instantiateViewController()
