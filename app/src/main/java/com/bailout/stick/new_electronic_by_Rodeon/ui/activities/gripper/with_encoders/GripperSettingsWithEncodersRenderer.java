...
//		GLES20.glClearColor(0.2f, 0.2f, 0.2f, 0.9f);
	...
	private void foreFinger (int[] shaderMassiv, int idForSelectObject) {
		...
		if (GripperScreenWithEncodersActivity.Companion.getAnimationInProgress4()) {
			Matrix.setIdentityM(currentRotation, 0);
		...
		/** поворот вокруг первой оси */
		if (GripperScreenWithEncodersActivity.Companion.getAnimationInProgress4()) {
			angleForeFingerTransfer = GripperScreenWithEncodersActivity.Companion.getAngleFinger4();
...
//		GLES20.glUniform1f(codeSelectUniform, (float) idForSelectObject);
	...
	private void middleFinger (int[] shaderMassiv, int idForSelectObject) {
		...
		/** поворот вокруг первой оси */
		if (GripperScreenWithEncodersActivity.Companion.getAnimationInProgress3()) {
			Matrix.setIdentityM(currentRotation, 0);
			if (GripperScreenWithEncodersActivity.Companion.getSide() == 0) {
		...
		/** поворот вокруг первой оси */
		if (GripperScreenWithEncodersActivity.Companion.getAnimationInProgress3()) {
			angleMiddleFingerTransfer = GripperScreenWithEncodersActivity.Companion.getAngleFinger3();
	...
	private void bigFinger (int[] shaderMassiv, int idForSelectObject)  {
		...
		/** поворот вокруг второй оси */
		if (GripperScreenWithEncodersActivity.Companion.getAnimationInProgress6()) {
			angleBigFingerTransfer2 = GripperScreenWithEncodersActivity.Companion.getAngleFinger6();
