...
import com.bailout.stick.databinding.FragmentCompleteSetBinding
...
class CompleteSetFragment: Fragment() {
    private var mContext: Context? = null
    private var main: MainActivity? = null

    private lateinit var binding: FragmentCompleteSetBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentCompleteSetBinding.inflate(layoutInflater)
