...
import com.bailout.stickk.databinding.Ubi4FragmentServiceAndWarrantyBinding

class ServiceWarrantyFragmentUBI4 : Fragment(R.layout.ubi4_fragment_service_and_warranty) {

    private var _binding: Ubi4FragmentServiceAndWarrantyBinding? = null
    private val binding get() = requireNotNull(_binding)

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding = Ubi4FragmentServiceAndWarrantyBinding.bind(view)
    ...
    private fun initUi() = with(binding) {
        ...
        ubi4ServiceAndWarrantyBtn.setOnClickListener { /* already here */ }
