...
import kotlinx.android.synthetic.main.fragment_care_of_prosthetic_hand.*
import kotlinx.android.synthetic.main.fragment_care_of_prosthetic_hand.service_and_warranty_btn
import kotlinx.android.synthetic.main.fragment_care_of_prosthetic_hand.title_click_block_btn
...
class ProsthesisCareFragment: Fragment() {
    private var rootView: View? = null
    private var mContext: Context? = null
    private var main: MainActivity? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val rootView = inflater.inflate(R.layout.fragment_care_of_prosthetic_hand, container, false)
