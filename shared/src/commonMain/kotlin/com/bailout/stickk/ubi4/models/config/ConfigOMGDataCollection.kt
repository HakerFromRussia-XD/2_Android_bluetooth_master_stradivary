...
data class ConfigOMGDataCollection(
    ...
    @SerialName("PRE_GEST_DURATION") var preGestDuration: Double? = null,
    @SerialName("AT_GEST_DURATION") var atGestDuration: Double? = null,
    @SerialName("POST_GEST_DURATION") var postGestDuration: Double? = null,
