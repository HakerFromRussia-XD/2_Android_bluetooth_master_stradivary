package com.bailout.stick.new_electronic_by_Rodeon.ui.fragments.help
...
import com.bailout.stick.databinding.FragmentHowToPutOnAProsthesisSocketBinding
...
class HowToPutOnProsthesesSocketFragment: Fragment() {
    private var mContext: Context? = null
    private var main: MainActivity? = null

    private lateinit var binding: FragmentHowToPutOnAProsthesisSocketBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentHowToPutOnAProsthesisSocketBinding.inflate(layoutInflater)
