package com.bailout.stick.old_electronic_by_Misha.ui.chat.view.gesture_settings;
...
import com.bailout.stick.old_electronic_by_Misha.data.GesstureAdapter;
import com.bailout.stick.old_electronic_by_Misha.data.Gesture_my;
import com.bailout.stick.old_electronic_by_Misha.ui.chat.data.ChatModule;
import com.bailout.stick.old_electronic_by_Misha.ui.chat.data.DaggerChatComponent;
        ...
        switch (position) {
            case 0:
                if(chatActivity.firstTapRecyclerView && chatActivity.isEnable){
                    ...
                    if (ChartActivity.NUMBER_CELL == 5 ) ChartActivity.NUMBER_CELL = (byte) (ChartActivity.NUMBER_CELL - 0x01);
                    chatActivity.fragmentManager.beginTransaction()
                            .setCustomAnimations(R.animator.show_fr, R.animator.remove_fr)
            ...
            case 1:
                if(chatActivity.firstTapRecyclerView && chatActivity.isEnable){
                    chatActivity.firstTapRecyclerView = false;
                    if (ChartActivity.NUMBER_CELL == 4 ) ChartActivity.NUMBER_CELL = (byte) (ChartActivity.NUMBER_CELL + 0x01);
                    chatActivity.fragmentManager.beginTransaction()
                            .setCustomAnimations(R.animator.show_fr, R.animator.remove_fr)
                            .add(R.id.view_pager, chatActivity.fragmentGripperSettings)
                            .addToBackStack("myStack")
