...
public class AndExAlertDialog {
    ...
    public static class Builder {
        ...
        private String title, message, oneBtnText, twoBtnText, threeBtnText, positiveBtnText, negativeBtnText;
        ...
        private AndExAlertDialogListener positiveListener, negativeListener, oneListener, twoListener, threeListener;
        ...
        public Builder setOneBtnText(String oneBtnText) {
            this.oneBtnText = oneBtnText;
            return this;
        }

        public Builder setTwoBtnText(String twoBtnText) {
            this.twoBtnText = twoBtnText;
            return this;
        }

        public Builder setThreeBtnText(String threeBtnText) {
            this.threeBtnText = threeBtnText;
            return this;
        }
        ...
        public Builder OnOneClicked(AndExAlertDialogListener oneListener) {
            this.oneListener = oneListener;
            return this;
        }

        public Builder OnTwoClicked(AndExAlertDialogListener twoListener) {
            this.twoListener = twoListener;
            return this;
        }

        public Builder OnThreeClicked(AndExAlertDialogListener threeListener) {
        ...
        public void build() {
            ...
            TextView btnNegativeText = v.findViewById(R.id.tv_andex_alert_dialog_layout_cancel_text),
                     ...
                     btnOneText = v.findViewById(R.id.tv_andex_alert_dialog_layout_one_text),
                     btnTwoText = v.findViewById(R.id.tv_andex_alert_dialog_layout_two_text),
                     btnThreeText = v.findViewById(R.id.tv_andex_alert_dialog_layout_three_text);
            ...
            View btnNegative = v.findViewById(R.id.v_andex_alert_dialog_layout_cancel),
                 ...
                 btnOne = v.findViewById(R.id.v_andex_alert_dialog_layout_one),
                 btnTwo = v.findViewById(R.id.v_andex_alert_dialog_layout_two),
                 btnThree = v.findViewById(R.id.v_andex_alert_dialog_layout_three);
            ...
            if (oneBtnText != null) {
                btnOneText.setText(oneBtnText);
            }

            if (twoBtnText != null) {
                btnTwoText.setText(twoBtnText);
            }

            if (threeBtnText != null) {
                btnThreeText.setText(threeBtnText);
            }
            ...
            if (oneListener != null) {
                ...
                btnOne.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        oneListener.OnClick(editText.getVisibility()==View.VISIBLE ? editText.getText().toString() : "");
                        dialog.dismiss();
                    }
                });
            ...
            if (twoListener != null) {
                ...
                btnTwo.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        twoListener.OnClick(editText.getVisibility()==View.VISIBLE ? editText.getText().toString() : "");
                        dialog.dismiss();
                    }
                });
            ...
            if (threeListener != null) {
                ...
                btnThree.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        threeListener.OnClick(editText.getVisibility()==View.VISIBLE ? editText.getText().toString() : "");
                        dialog.dismiss();
                    }
                });
