...
public class UBI4GripperSettingsWithEncodersGLSurfaceView extends GLSurfaceView implements UBI4ErrorHandler
{
	private UBI4GripperSettingsWithEncodersRenderer renderer;
//	private TextView panelInfo;
	...
	public UBI4GripperSettingsWithEncodersGLSurfaceView(Context context, AttributeSet attrs) { super(context, attrs); }
...
//					System.err.println("deltaY="+deltaY);
	...
	public void setRenderer(UBI4GripperSettingsWithEncodersRenderer renderer, float density)
	{
