...
import com.bailout.stickk.databinding.Ubi4FragmentChargingTheProsthesisBinding

class ChargingFragmentUBI4 : Fragment(R.layout.ubi4_fragment_charging_the_prosthesis) {

    private var _binding: Ubi4FragmentChargingTheProsthesisBinding? = null
    private val binding get() = requireNotNull(_binding)

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding = Ubi4FragmentChargingTheProsthesisBinding.bind(view)
    ...
    private fun initUi() = with(binding) {
        ...
        ubi4ProsthesesChargeBtn.setOnClickListener { /* already here */ }
