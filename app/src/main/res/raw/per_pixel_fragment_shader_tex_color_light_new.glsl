...
//vec4 resultColor = vec4(1.0, 0.0, 0.0, 1.0);
...
void main()
{
    ...
    vec4 resultColor = vec4(u_Color, 0.0, 0.0, 1.0);//u_Color
    vec4 diffColor = diffMatColor * u_lightPower * diffuse / (1.0 + 0.25 * pow(distance, 2.0));
