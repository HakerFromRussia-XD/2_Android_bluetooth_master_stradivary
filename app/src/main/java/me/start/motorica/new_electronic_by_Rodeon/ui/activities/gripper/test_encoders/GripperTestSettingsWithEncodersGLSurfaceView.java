...
import me.start.motorica.new_electronic_by_Rodeon.ui.activities.gripper.with_encoders.GripperSettingsWithEncodersRenderer;

public class GripperTestSettingsWithEncodersGLSurfaceView extends GLSurfaceView implements ErrorHandler
{
	private GripperTestSettingsWithEncodersRenderer renderer;
//	private TextView panelInfo;
	...
	public GripperTestSettingsWithEncodersGLSurfaceView(Context context, AttributeSet attrs) { super(context, attrs); }
...
//					System.err.println("deltaY="+deltaY);
	...
	public void setRenderer(GripperTestSettingsWithEncodersRenderer renderer, float density)
	{
