...
internal class DataFactory {
        ...
        listWidgets.forEach {
            when (it::class.simpleName) {
                CommandParameterWidgetEStruct::class.simpleName -> {
                    addElement((it as CommandParameterWidgetEStruct).baseParameterWidgetEStruct.baseParameterWidgetStruct.widgetCode, objects, it)
                ...
                PlotParameterWidgetEStruct::class.simpleName -> {
                    addElement((it as PlotParameterWidgetEStruct).baseParameterWidgetEStruct.baseParameterWidgetStruct.widgetCode, objects, it)
    ...
    private fun addElement(widgetCode: Int, objects: ArrayList<Any>, widget: Any) {
